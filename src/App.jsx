...
const App = () => {
 ...
 // inicializar o contrato editionDrop
  const editionDrop = useEditionDrop("0x9a681e21144F21AB91361876fF73f8b295e211F4");
  const token = useToken("0x7bDb893740906494152ea75298f2984617931e0E");
  const vote = useVote("0x278f24A68f5340fA5b2Daa2868a6bf726d37ccab");
...
if (hasClaimedNFT) {
 return (
    <div className="member-page">
      <h1>Página dos membros da OrigamiDAO</h1>
      <p>Parabéns por fazer parte desse clube de origameiros!</p>
      <div>
        <div>
  ...
  return (
    <div className="mint-nft">
      <h1>Cunhe gratuitamente seu NFT de membro da OrigamiDAO</h1>
      <button
        disabled={isClaiming}
        onClick={mintNft}
      >
